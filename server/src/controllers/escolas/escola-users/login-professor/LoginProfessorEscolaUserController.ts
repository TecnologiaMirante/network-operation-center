...
import { FindProfessorEscolaUsersLoginDataService } from "../../../../services/escolas/escola-users/FindProfessorEscolaUserLoginDataService";

class LoginProfessorEscolaUserController {
  async handle(req:Request, res:Response) {
    ...
    const findProfessorEscolaUsersLoginDataService = new FindProfessorEscolaUsersLoginDataService(prismaEscolaUsersRepository);

    // Executando o service para receber os dados de login
    const user = await findProfessorEscolaUsersLoginDataService.execute({ id: Object(escolaUser).user_id });
...
export { LoginProfessorEscolaUserController };